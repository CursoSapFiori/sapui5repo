			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TerminalApp-display": {
								"semanticObject": "TerminalApp",
								"action": "display",
								"description": "Fiori App Terminal",
								"title": "Terminal App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ccss.sap.ccssterminal",
									"url": sap.ui.require.toUrl("ccss/sap/ccssterminal")
								}
							}
						}
					}
